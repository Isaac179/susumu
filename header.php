	...
	<div class=" row contenedor-header">
		...
		<div class="row ">
			...
			<!-- <a class="contacto-logo href="<?php $url = home_url(); echo $url; ?>"  >
				...
				<?php if( is_home()) :?>
				 	<a href="<?php $url = home_url(); echo $url; ?>" data-scroll-nav="servicios">Home</a>
				<?php else:?>
					<a href="<?php $url = home_url(); echo $url; ?>">Home</a>
				<?php endif;?>
				
				<a href="<?php bloginfo('url'); ?>/empresas2">Discography</a>

				<a href="<?php echo get_post_type_archive_link( 'trabajos_pt' ); ?>">Labels</a>
					<!-- <a href="<?php echo get_post_type_archive_link( 'single-trabajos_pt' ); ?>" class="nosotros-chico">Trabajos</a> -->
				
				
				 <?php if( is_home()) : ?>
				 	<a href="<?php bloginfo('url'); ?>/servicios" data-scroll-nav="plan-eliseo" class="desaparece-chico"  class="nosotros-chico">History</a>
				 	<a href="<?php bloginfo('url'); ?>/nosotros" data-scroll-nav="plan-eliseo" class="desaparece-chico"  class="nosotros-chico">Contact</a>
